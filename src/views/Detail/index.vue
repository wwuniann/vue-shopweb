    ...
    <div class="container" v-if="goods.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- 
            错误原因：goods一开始{}  {}.categories -> undefined  -> undefined[1]即当goods还是一个空对象时，还没有拿到数据就用来渲染，就会报错。
            解决办法
            1. 可选链的语法?.（即在无法获取的前面加?.这个地方就应该是goods.categorys?.[1].id） 
            2. v-if手动控制渲染时机 保证只有数据存在才渲染（这个在标签中先判断gooods是否拿到数据,即v-if='goods.details'）
           -->
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
               <JxImageView :image-list="goods.mainPictures"/>
              <!-- 统计数量 -->
